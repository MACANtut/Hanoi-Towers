...
class HanoiTowersGame(QWidget):
    ...
    def exit_to_menu(self, dialog):
        ...
        dialog.close()
        self.return_to_menu.emit()  # Важное исправление - испускаем сигнал перед закрытием
    ...
    def update_next_level_button_state(self):
        self.next_level_button.setEnabled(self.level_completed and self.level < self.max_levels)
