...
class MainWindow(QWidget):
    ...
    def start_game(self):
        ...
        self.hide()
        self.game_window.show()  # Важное исправление - показываем игровое окно

    def return_to_menu(self):
        self.game_window.close()  # Важное исправление - закрываем игровое окно
        self.show()  # Показываем главное меню
        self.setGeometry(self.last_geometry)  # Восстанавливаем геометрию
